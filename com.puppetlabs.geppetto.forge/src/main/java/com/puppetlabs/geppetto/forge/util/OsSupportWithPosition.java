...
public class OsSupportWithPosition extends OsSupport implements FilePosition {
	...
	public OsSupportWithPosition(FilePosition pos) {
	...
	public OsSupportWithPosition(int offset, int length, int line, File file) {
		this.offset = offset;
		this.length = length;
		this.line = line;
		this.file = file;
